...
export const AddForm = () => {
    ...
    if (loading) {
        return <h2> Trwa doawanie ogłoszenia... </h2>
    }

    if (id) {
        return <h2>Twoje ogłoszenie "{form.name}" zostałao poprawnie dodane do serwisu "{id}" </h2>
    }
        ...
        <p>
            <label>
                ...
                <input 
                    ...
                    required
                /> <br/>
                <small>Pozostaw zero w polu, aby nie wyśweitlać ceny</small>
            </label>
        </p>
        <p>
            <label>
